...
class GameWishlistRepository {
    fun getFakeWishlistGames(): List<WishlistGame> {
        val g1 = Game("Cult of the Lamb", 3)
        g1.imageUrl = "https://images.igdb.com/igdb/image/upload/t_cover_big/co55md.webp"
        val g2 = Game("Have a Nice Death", 4)
        g2.imageUrl = "https://images.igdb.com/igdb/image/upload/t_cover_big/co4a9g.webp"
